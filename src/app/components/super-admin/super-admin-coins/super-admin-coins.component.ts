...
@Component({
  selector: 'app-super-admin-coins',
  templateUrl: './super-admin-coins.component.html',
  styleUrls: ['./super-admin-coins.component.scss']
})
export class SuperAdminCoinsComponent implements OnInit {
  page = 1;
  perPage = 50;
  total = 0;
  searchKey: any = '';
